...
这几天实在太忙，已经请两天假了，今天就只够时间做一道了。后面有时间开始再追追进度。

### 2024.09.07

#### 第26题DoublerEntry

海南遭遇17级台风。。。断水断电一天，晚上还不容易来电了，赶紧打卡，真没时间和精力做题了今天。申请放过一天🙁
...
coin会调用要转账地址的notify方法，利用这一点我们就可以在攻击合约中revert特定错误，使得被攻击合约的代码走进我们希望走进的逻辑分支。所以还是那句话，把自己合约的主动权交给外部是十分危险的。
另外就是攻击合约里recevie里不能简单地拒绝所有的value，我们是要拒绝的是数量为10的交易，使被攻击合约发送所有余额给我们。如果我们拒绝了所有，那我们就无法收到所有余额了。
