...
import {GatekeeperOne} from "../../challenge-contracts/13-GatekeeperOne.sol";
...
contract GatekeeperOneSolution is Script, EthernautHelper {
    ...
    function run() public {
        ...
        GatekeeperOne one = GatekeeperOne(challengeInstance);
        address heroAddress = vm.addr(heroPrivateKey);
        require(one.entrant() == heroAddress, "Entrant check failed");
...
contract Solution {
    ...
    constructor(address oneAddress) {
        gateAddress = oneAddress;
    }
