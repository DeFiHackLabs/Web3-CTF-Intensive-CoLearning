...
contract PuppetChallenge is Test {
    ...
    uint256 constant UNISWAP_INITIAL_TOKEN_RESERVE = 10e18; // 10   DVT
    uint256 constant UNISWAP_INITIAL_ETH_RESERVE = 10e18; // 10   eth
    uint256 constant PLAYER_INITIAL_TOKEN_BALANCE = 1000e18; // 1000 DVT
    uint256 constant PLAYER_INITIAL_ETH_BALANCE = 25e18; // 25   eth
