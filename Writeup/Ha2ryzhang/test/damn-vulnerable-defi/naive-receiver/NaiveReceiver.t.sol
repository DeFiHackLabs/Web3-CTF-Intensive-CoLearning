...
import {NaiveReceiverPool, Multicall, WETH} from "../../../src/damn-vulnerable-defi/naive-receiver/NaiveReceiverPool.sol";
import {FlashLoanReceiver} from "../../../src/damn-vulnerable-defi/naive-receiver/FlashLoanReceiver.sol";
import {BasicForwarder} from "../../../src/damn-vulnerable-defi/naive-receiver/BasicForwarder.sol";
...
contract NaiveReceiverChallenge is Test {
    ...
    function test_naiveReceiver() public checkSolvedByPlayer {
        console.log(
            "recvier balance",
            weth.balanceOf(address(receiver)) / 1e18
        );
        console.log("pool balance", weth.balanceOf(address(pool)) / 1e18);
        console.log("player balance", weth.balanceOf(address(player)) / 1e18);
