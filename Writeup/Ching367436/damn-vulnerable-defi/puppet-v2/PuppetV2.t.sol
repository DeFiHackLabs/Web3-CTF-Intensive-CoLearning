...
contract PuppetV2Challenge is Test {
    ...
    function test_puppetV2() public checkSolvedByPlayer {
        ...
        */
        ...
        console.log("calculateDepositOfWETHRequired(POOL_INITIAL_TOKEN_BALANCE): ", calculateDepositOfWETHRequired(POOL_INITIAL_TOKEN_BALANCE));
    ...
    function _getOracleQuote(uint256 amount) private view returns (uint256) {
        (uint256 reservesWETH, uint256 reservesToken) =
            UniswapV2Library.getReserves({factory: address(uniswapV2Factory), tokenA: address(weth), tokenB: address(token)});
